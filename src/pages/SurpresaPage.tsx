...
function FinalScreen() {
  ...
  return (
   <div className="min-h-screen bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 overflow-y-auto overflow-x-hidden">
      {/* Particles */}
      <Particles count={50} color="rgba(212, 175, 55, 0.4)" />

      {/* Content */}
      <div
  className={`relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 py-16 text-center transition-all duration-1000 ${
